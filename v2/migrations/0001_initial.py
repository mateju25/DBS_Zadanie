# Generated by Django 3.1.6 on 2021-04-27 12:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField()),
                ('updated_at', models.DateTimeField()),
                ('bulletin_issue', models.ForeignKey(on_delete=django.db.models.deletion.RESTRICT, to='v2.bulletinissues')),
            ],
            options={
                'db_table': 'raw_issues',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('postal_code', models.CharField(blank=True, max_length=255, null=True)),
                ('city', models.CharField(blank=True, max_length=255, null=True)),
                ('bulletin_issue', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='v2.bulletinissues')),
                ('company', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.RESTRICT, to='v2.companies')),
                ('raw_issue', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='v2.rawissues')),
            ],
            options={
